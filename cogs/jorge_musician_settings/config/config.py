...
SPOTIFY_ID: str = os.environ["SPOTIFY_CLIENT_ID"]
SPOTIFY_SECRET: str = os.environ["SPOTIFY_CLIENT_SECRET"]
...
COOKIE_PATH = "/cogs/jorge_musician_settings/config/cookies/cookies.txt"
...
HELP_HISTORY_LONG = f"Shows the {str(MAX_TRACKNAME_HISTORY_LENGTH)} last played songs."
